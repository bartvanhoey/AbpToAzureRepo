...
namespace AbpToAzure.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpToAzureDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpToAzureEfCoreEntityExtensionMappings to extend the IdentityUser entity
